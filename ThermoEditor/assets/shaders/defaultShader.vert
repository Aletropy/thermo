...
layout(location = 3) in vec2 v_TexUVSize;
layout(location = 4) in float v_TexIndex;
layout(location = 5) in float v_TillingFactor;
layout(location = 6) in vec4 v_VertexColor;

layout(location = 0) out vec2 a_TexCoords;
layout(location = 1) out vec2 a_TexUV;
layout(location = 2) out vec2 a_TexUVSize;
layout(location = 3) out float a_TexIndex;
layout(location = 4) out float a_TillingFactor;
layout(location = 5) out vec4 a_VertexColor;
